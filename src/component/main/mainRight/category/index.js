      ...
      <>
        <div className="comeinand1_title">
          <div className="title_table tt2" >
            <span className="day_lenh open_tab" style={{ cursor: 'pointer' }}>Vị thế mở</span>
            <span className="control_lenh close_tab" style={{ cursor: 'pointer' }}>Vị thế đóng</span>
          </div>
          <div className="icon_cn">
            <FontAwesomeIcon icon={faSyncAlt} className="icon_ld" style={{ cursor: 'pointer' }} />
            <FontAwesomeIcon icon={faMinus} className="icon_ld" style={{ cursor: 'pointer' }} />
          </div>
        </div>
